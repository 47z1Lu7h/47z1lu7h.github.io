...
img: assets/img/fallCabal/fallCabalLogo.png
importance: 1
tag: dark_side
category: dark_side
comments: true
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/fallCabal/fallCabal-2.jpeg" title="" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<hr>
